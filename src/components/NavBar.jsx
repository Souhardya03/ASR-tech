...
const NavBar = () => {
	...
	return (
		<div className="flex items-center justify-center">
			...
			{/* Top NavBar */}
			<nav className="bg-white p-2 sm:p-4 max-w-[1920px] mx-auto md:py-6 lg:py-4 px-4 sm:px-6 md:px-6 xl:px-14  fixed z-20 w-full top-0 flex flex-wrap justify-between items-center gap-3">
				{/* Logo */}
