...
const CountdownTimer = () => {
	...
	return (
		<div className="flex items-center mr-6 text-[#636363]">
			...
			<div className="px-8">
				...
				<div className="py-8">
					...
					<div className="mt-14 mb-16 flex items-center justify-center text-center font-medium cursor-pointer">
						<NavLink to={"/products"} onClick={()=>window.scrollTo(0,0)} className="text-white p-4 w-[20%] rounded-md text-lg bg-[#F54A00]">
							View All Products
						</NavLink>
					</div>
				</div>
